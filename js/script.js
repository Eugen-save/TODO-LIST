{
    ...
    const bindToggleHideEvents = () => {
        ...
        if (toggleHideButton) {
            toggleHideButton.addEventListener("click", toggleHideTasksDone);
        };
    };
    ...
    const bindCompleteTasksEvents = () => {
        ...
        if (completeTasksButton) {
            completeTasksButton.addEventListener("click", setAllTasksDone);
        };
    };
    ...
    const renderButtons = () => {
        ...
        buttonsElement.innerHTML = `
            <button class="section__button js-hide" ${tasks.every( ({ done }) => !done) ? "disabled" : "" } >
